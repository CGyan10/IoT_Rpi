...
firebase= firebase.FirebaseApplication('https://console.firebase.google.com/project/dth11-de675/database/dth11-de675-default-rtdb/data/~2F')
while True:
